...
public class CleaningSuppliesType extends Model {
    ...
    public static Finder<Integer, CleaningSuppliesType> find = new Finder<>(CleaningSuppliesType.class);

    public CleaningSuppliesType() {}
    public CleaningSuppliesType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
