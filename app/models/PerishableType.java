...
@Entity
public class PerishableType extends Food {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, PerishableType> find = new Finder<>(PerishableType.class);

    public PerishableType() {}
    public PerishableType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
