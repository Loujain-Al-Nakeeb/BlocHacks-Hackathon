...
@Entity
public class DeskSupplies extends Supplies {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, DeskSupplies> find = new Finder<>(DeskSupplies.class);

    public DeskSupplies() {}
    public DeskSupplies(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
