...
@Entity
public class LaundryAppliancesType extends Appliances {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, LaundryAppliancesType> find = new Finder<>(LaundryAppliancesType.class);

    public LaundryAppliancesType() {}
    public LaundryAppliancesType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
