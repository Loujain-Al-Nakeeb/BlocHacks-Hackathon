...
@Entity
public class KitchenAppliancesType extends Appliances {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, KitchenAppliancesType> find = new Finder<>(KitchenAppliancesType.class);

    public KitchenAppliancesType() {}
    public KitchenAppliancesType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
