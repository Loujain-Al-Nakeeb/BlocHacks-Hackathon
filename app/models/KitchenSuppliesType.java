...
@Entity
public class KitchenSuppliesType extends Supplies {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, KitchenSuppliesType> find = new Finder<>(KitchenSuppliesType.class);

    public KitchenSuppliesType() {}
    public KitchenSuppliesType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
