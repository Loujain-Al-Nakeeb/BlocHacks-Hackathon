...
@Entity
public class BathroomSuppliesType extends Supplies {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY) private Integer id;
    @Constraints.Required private String en;
    @Constraints.Required private String fr;

    public static Finder<Integer, BathroomSuppliesType> find = new Finder<>(BathroomSuppliesType.class);

    public BathroomSuppliesType() {}
    public BathroomSuppliesType(@Constraints.Required String en, @Constraints.Required String fr) {
        this.en = en;
        this.fr = fr;
    }
